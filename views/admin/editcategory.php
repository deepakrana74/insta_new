...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
        <li>Home</li><li>Manage Category</li><li> Edit Category & hash Tags</li>
        </ol>
    </div>
    <!-- END RIBBON -->
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark">
                    ...
                    <!-- PAGE HEADER -->
                    <i class="fa-fw fa fa-cubes"></i>Manage Category<span>> Edit Category & hash Tags</span>
                </h1>
            </div>
        </div>
            ...
            <form id="category-form" class="smart-form" method="post" enctype="multipart/form-data" novalidate="novalidate">
                ...
                <fieldset>
                    <div class="row">
                        <section class="col col-6">
                            <label class="input"> <i class="icon-append fa fa-cubes"></i>
                                <input type="text" name="title" value="<?= $Data['SubCategory']->sub_category_name ?>" placeholder="Title">
                            </label>
                        </section>
                    </div>
                    ...
                    <section>
                        ...
                        <textarea id="tags" name="tags" required><?= $Data['SubCategory']->hash_tags ?></textarea>
                        </label>
                    </section>
                </fieldset>
                <footer>
